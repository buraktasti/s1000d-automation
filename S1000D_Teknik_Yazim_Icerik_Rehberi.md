# S1000D Bilgi Setleri — Teknik Yazım İçerik Rehberi
### ELD Ekibi için: "Bu başlık altına ne yazılır?" — kaynak: Bilgi_Setleri-S1000D_Issue_5_0.pdf (Ch 5.2.1, Ortak Bilgi Setleri) + Bilgi_Setleri-002-S1000D_Issue_5_0.pdf (Ch 5.2.3, Kara/Deniz Özel Bilgi Setleri)

Bu doküman DMC kodlama kurallarını değil, **her bilgi setinde teknik içeriğin ne olması/ne olmaması gerektiğini** anlatır. Her bölüm kaynak dokümandaki ifadelere sadıktır; ekleme/yorum yapılmamıştır.

---

# BÖLÜM A — ORTAK BİLGİ SETLERİ (Chapter 5.2.1)

## A.1 — Crew/Operator information (5.2.1.1)
...
## A.2 — Description and operation (5.2.1.2) ⭐
...
## A.3 — Maintenance information (5.2.1.3) — genel şemsiye, alt bölümlere referans verir

### A.3.1 — Maintenance procedures (5.2.1.3.1)
...
### A.3.2 — Fault isolation (5.2.1.3.2) ⭐
...
### A.3.3 — Non-destructive testing / NDT (5.2.1.3.3)
...
### A.3.4 — Corrosion control (5.2.1.3.4)
...
## A.5 — Illustrated parts data / IPD (5.2.1.5)
...
## A.6 — Maintenance planning information (5.2.1.6)
...
## A.7 — Mass and balance information (5.2.1.7)
...
## A.8 — Recovery information (5.2.1.8) ⭐ (ZKA görev tanımıyla örtüşüyor)
...
## A.9 — Equipment information / SE-TE-CM (5.2.1.9) ⭐ (sökülmüş bileşen el kitabı rehberi)
...
## A.10 — Weapon loading information (5.2.1.10)
...
## A.11 — Cargo loading information (5.2.1.11)
...
## A.12 — Stores loading information (5.2.1.12)
...
## A.13 — Role change information (5.2.1.13)
...
## A.14 — Battle damage assessment and repair / BDAR (5.2.1.14)
...
## A.15 — Illustrated tool and support equipment / ITE (5.2.1.15)
...
## A.16 — Service bulletins (5.2.1.16)
...
## A.18 — Common information and data / CID (5.2.1.18)
...
## A.20 — List of applicable publications / LOAP (5.2.1.20)
...
## A.21 — Maintenance checklists and inspections (5.2.1.21)
...
## B.1 — Crew/Operator descriptive information (5.2.3.1)
...
## B.2 — Crew/Operator operation information (5.2.3.2)
...
## B.3 — Crew/Operator sequential operation information (5.2.3.3)
...
## B.4 — Crew/Operator fault detection, isolation and resolution / FDIR (5.2.3.4) ⭐
...
## B.5 — International, national and regulatory scheduled check information / INRSC (5.2.3.5)
